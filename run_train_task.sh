...
CUDA_VISIBLE_DEVICES=5 python src/train.py --model_name_or_path=facebook/wav2vec2-large-xlsr-53 \
...
CUDA_VISIBLE_DEVICES=6 python src/train.py --model_name_or_path=facebook/wav2vec2-large-xlsr-53 \
...
CUDA_VISIBLE_DEVICES=7 python src/train.py --model_name_or_path=facebook/wav2vec2-large-xlsr-53 \
...
CUDA_VISIBLE_DEVICES=5 python src/train.py --model_name_or_path=facebook/wav2vec2-large-xlsr-53 \
   --task_config_name titml_idn_nusantara_sptextindspeech_newstra_ethnicsr_nooverlap_sun_nusantara_sptext \
   --preprocessing_num_workers=16 --audio_column_name=audio --text_column_name=text \
   --per_device_train_batch_size=16 --per_device_eval_batch_size=16 \
   --dataloader_num_workers=16 --dataloader_pin_memory \
   --seed=14045 --num_train_epochs=30 --learning_rate=5e-5 --fp16 \
   ...
   --metric_for_best_model=mer --greater_is_better=False \
   --gradient_checkpointing=True \
   --cache_dir=./cache/titml_idn/ \
   --output_dir=./save/titml_idn/
